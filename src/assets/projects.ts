...
const PROJECTS: Project[] = [
  {
    ...
    markdownDescription:
      "A website where users can pick their favorite games in 1 vs 1 battles.",
  },
  {
    ...
    markdownDescription:
      "A small interactive website that illustrates the Monty Hall Problem.",
  },
  {
    ...
    images: [
      ...
      {
        imageLink: millie2,
        altText: "Millie in a living room ready to make tea.",
      },
    ],
    markdownDescription:
      "A small point and click adventure made in collaboration with an illustrator.",
  },
  {
    ...
    markdownDescription:
      "Online multiplayer type racing game. Frontend made in GameMaker backend made with NodeJs.",
  },
  {
    ...
    markdownDescription:
      "Mockup of the Recurse Center made during 7 day Halloween Hackathon.",
  },
  {
    title: "PixelMove",
    ...
    images: [
      ...
      {
        imageLink: stairstepFixed,
        altText: "Screen shot of fixed pixel movement.",
      },
    ],
    markdownDescription:
  ...
  },
  {
    ...
    images: [
      ...
      {
        imageLink: scoreApp02,
        altText: "Screen shot of options modal in score keeping app.",
      },
    ],
  ...
  },
  {
    ...
    linkProject:
      "https://gla55world.itch.io/dialog-scene-test?secret=FWyPf45aSyQESRo9k7sMDmlhaM0",
    images: [
  ...
  },
  {
    ...
    images: [
      {
        imageLink: sitereadingapp,
        altText: "Screen shot of piano sight-reading app.",
      },
    ],
  ...
  },
  {
    title: "Music",
    linkProject:
      "https://www.universalproductionmusic.com/en-us/search?q=evan%20conway&qtext=evan%20conway&vtag=0&vwave=0&vdesc=1&ktype=6",
    markdownDescription:
      "Over 250 pieces of music written for TV, radio, and various media. Some examples are [Beautiful Entanglement](http://links.universalproductionmusic.com/CnDcyu), [Nuts And Bolts](http://links.universalproductionmusic.com/nfgSlm), [Glorious Dawn](http://links.universalproductionmusic.com/T23gTi), and [Adorable Saves The Day](http://links.universalproductionmusic.com/sU9fpv)",
  },
];

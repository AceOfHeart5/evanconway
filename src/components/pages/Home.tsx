const Home = () => {
    return (
        <article style={{ maxWidth: "900px", paddingBottom: "32px" }}>
            <h1>About Me</h1>
            <p>
            ...
            <p>
                If you'd like to know more check out my blog or demo projects linked above!
            </p>
            <p>
                I'm currently job searching. If you're interested in contacting me, please reach out. I'd love to hear from you!
            </p>
            <div>evanconwaymusic@gmail.com</div>        
            <a href="https://docs.google.com/document/d/1qRQ8ZiwPFS40rOGruCJJj6VH0nnWQdo6qOWGVO3WV4g/preview">Resume</a>
        </article>
    );
};
